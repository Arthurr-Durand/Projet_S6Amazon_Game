...
{
    return (new_move.queen_src == new_move.queen_dst || new_move.arrow_dst == new_move.queen_dst || new_move.queen_src >= size || new_move.queen_dst >= size || new_move.arrow_dst >= size);
}
